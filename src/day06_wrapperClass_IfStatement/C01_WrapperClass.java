...
public class C01_WrapperClass {
	...
	public static void main(String[] args) {
		...
		//sayi2. yazdigimizda ise bir cok methodlar geliyior, cunku sayi2 Integer'dir yani Wrapper class'dir
		...
		// Ineger.valueOf(String numerik ifade) methodu string olarak kaydedilmis 
