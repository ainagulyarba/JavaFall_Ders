...
public class C01_LocalDate {
	...
	public static void main(String[] args) {
		...
		LocalDate dogumTarihi1=LocalDate.of(1998, Month.JANUARY, 22);//1998-01-22,
		LocalDate dogumTarihi2 = LocalDate.of(2000, 01, 12);//2000-01-12
		LocalDate dogumTarihi3=LocalDate.of(1985, 10, 10);//1985-10-10
		
		System.out.println(dogumTarihi1+", "+dogumTarihi2);//1998-01-22, 2000-01-12
