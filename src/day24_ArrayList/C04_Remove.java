...
public class C04_Remove {
	...
	public static void main(String[] args) {
		...
		System.out.println(harfler);//harfler.add("A");
		
		System.out.println(harfler.remove(1));//bu satir 1 index'indeki elemani remove eder
		...
		System.out.println(harfler.remove("B"));//false ; listede B olmadigi icin remove yapamaz
		...
		System.out.println(harfler);//[A, Z, F]ilk A sildi
		...
		//eger listemiz integer'lerden olusuyorsa
