...
public class JeepRunner {
	...
	public static void main(String[] args) {
		...
		System.out.println(jeep1.fiayt+" "+ jeep1.ilanNo+" "+jeep1.marka+" "+jeep1.model+ 
				
							" "+jeep1.yil);//10000 1001 null null 2001
		//jeep class'indaki variable'lar instance variable'lar olduklarindan 
		//atadigim degerleri sadece benim objem icin degerleri degistirir
		...
		System.out.println(jeep1.fiayt+" "+ jeep1.ilanNo+" "+jeep1.marka+" "+jeep1.model+ 
				...
				" "+jeep1.yil); //15000 1002 Toyota Corolla 2005
