...
public class C04_ExplisitNaro {
	...
	public static void main(String[] args) {
		...
		//deger byte'in sinirlarindan buyuk oldugu icin Java int300'u kendi tontemine gore
		...
		int sayi5= (int) sayi4;
		 ...
		 // deger virgullu oldugundan ve int4da ondalikli kisim olmadigindan java ondalikli kismi keser
		// dolayisiyla data kaybi olusur
		 ...
		 //bolme islemi yapilan iki sayi da int oldugu icin
		 ...
		 // 6.75 islem yapilan sayilardan daha genis data turune sahip olan 
